...
const LLAVE_IZQUIERDA: BracketSide = {
  ...
  octavos: [
    { p1: "SouthSeba", p2: "Yoni" },
    { p1: "Nico", p2: "Atomic" },
    { p1: "Heartless2202", p2: "Sebax" },
    { p1: "JoseEduby", p2: "Tezcat" },
  ],
  cuartos: [
    { p1: "SouthSeba", p2: "Atomic" },
    { p1: "Sebax", p2: "JoseEduby" },
  ],
  semifinal: [{ p1: "", p2: "" }],
  finalista: "",
};
...
const LLAVE_DERECHA: BracketSide = {
  ...
  octavos: [
    { p1: "Uyitoo", p2: "Fher-Mrtz" },
    { p1: "Lanfirer", p2: "Ral" },
    { p1: "Andueza", p2: "Nikolas" },
    { p1: "Aroyuuki", p2: "JoseVGC" },
  ],
  cuartos: [
    { p1: "Uyitoo", p2: "Lanfirer" },
    { p1: "Nikolas", p2: "Aroyuuki" },
  ],
  semifinal: [{ p1: "", p2: "" }],
  finalista: "",
};
