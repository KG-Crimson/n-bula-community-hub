...
const CHAMPS: Champion[] = [
  ...
  },
  {
    ...
    players: "40 personas",
    team: [
      { id: 454, name: "Tierrita" },
      { id: 94, name: "Voldemort" },
      { id: 474, name: "Red" },
      { id: 475, name: "Rosa" },
      { id: 450, name: "Gustavito" },
      { id: 289, name: "Val" },
    ],
  },
  {
    ...
    players: "60 personas",
    team: [
      { id: 778, name: "Yolito origin" },
      { id: 289, name: "Nemesio" },
      { id: 567, name: "Yolito 2" },
      { id: 282, name: "Royito" },
      { id: 639, name: "Volkner" },
      { id: 260, name: "Ulises" },
    ],
  },
  {
    ...
    team: [
      { id: 169, name: "Batman" },
      { id: 465, name: "Malicius" },
      { id: 282, name: "Yuno" },
      { id: 242, name: "Chansilla" },
      { id: 34, name: "El King" },
      { id: 445, name: "Drayani" },
    ],
  },
